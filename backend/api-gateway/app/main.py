...
from app.api import health, leads, core, analytics
...
# Proxy to core-service for /auth/*, /company/*, /profile/*, etc.
app.include_router(core.router, prefix="", tags=["core-proxy"])
