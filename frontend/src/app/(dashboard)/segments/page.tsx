      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={() => { setShowBuilder(true); setActiveTab('builder'); setEditingSegment(null); setBuilderName(''); setBuilderDescription(''); setBuilderRules([{ id: '1', field: 'score', operator: '>', value: '70', connector: 'AND' }]); setPreviewLeads([]) }}
            className="px-4 py-2 bg-[#7C4DFF] text-white rounded-lg hover:bg-[#FD1D1D] text-sm">
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-lg border border-dashed border-gray-300 p-12 text-center">
              ...
              <button onClick={() => setActiveTab('builder')}
                className="mt-4 px-4 py-2 bg-[#7C4DFF] text-white rounded-lg hover:bg-[#FD1D1D]">
                ➕ Créer un segment
              </button>
            </div>
          ) : (
            ...
            <div className="bg-white rounded-lg border p-6">
              ...
              <div className="flex gap-3 mt-4">
                ...
                <button onClick={handleSaveSegment}
                  className="px-6 py-2 bg-[#7C4DFF] text-white rounded-lg hover:bg-[#FD1D1D] text-sm">
