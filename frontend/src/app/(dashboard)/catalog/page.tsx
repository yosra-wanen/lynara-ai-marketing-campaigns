...
import { Plus, Pencil, Trash2, MapPin, Search, SlidersHorizontal, LayoutGrid, List, Users } from "lucide-react";
...
export default function CataloguePage() {
  ...
  <Link
    ...
    className="flex items-center gap-1.5 text-xs font-medium text-gray-500 dark:text-gray-400 hover:text-[#7C4DFF] border border-gray-200 dark:border-white/10 hover:border-[#7C4DFF]/30 px-3 py-1.5 rounded-full transition"
  >
    <Users size={13} />
    Fournisseurs
  </Link>
